...
public class FileBasedInterestManager implements InterestManager {
	...
	private void readInterest(){
		try{
			...
			//Model	interestExpr = RDFDataMgr.loadModel(filename);
	...
	private Query getSubscribersQuery(){
		String qstr = SPARQLExecutor.prefixes() 
				...
				+ "             <http://eis.iai.uni-bonn.de/irap/ontology/sourceEndpoint> ?sourceEndpoint; "
				+ "             <http://eis.iai.uni-bonn.de/irap/ontology/subscriber> ?subscriber; "
				+ "             <http://eis.iai.uni-bonn.de/irap/ontology/changesetPublicationType> ?changesetPublicationType; "
				+ "             <http://eis.iai.uni-bonn.de/irap/ontology/changesetBaseURI> ?changesetBaseURI;   "
				+ "             <http://eis.iai.uni-bonn.de/irap/ontology/lastPublishedFilename>  ?lastPublishedFilename; "
